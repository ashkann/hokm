...
//  }
//
//  def playHand(eldest: InGamePlayer): Hand = {
//    val hand = new Hand(team1,team2)
//
//    repeatUntil2[Hand,InGamePlayer] { lead =>
...
//  }
//
//  def playTrick(lead: InGamePlayer): Trick = {
...
//      new InGamePlayer("Jake", toHand(h1)),
//      new InGamePlayer("Bella", toHand(h2)),
//      new InGamePlayer("Edward", toHand(h3)),
//      new InGamePlayer("Ashkan", toHand(h4))
//    ))
//
